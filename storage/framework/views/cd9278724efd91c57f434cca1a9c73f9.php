...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="<?php echo e(route('produk.show', $product)); ?>" class="btn btn-info btn-sm">Detail</a>
        ||
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos7\resources\views/produk/index.blade.php ENDPATH**/ ?>